  ...
  return (
    <>
        ...
        <div id='all' className="flex flex-col space-y-12 max-w-7xl mx-auto my-12 px-4 md:px-8 justify-center items-center">
          <h2 className=" w-[15em] md:w-[20em] text-center text-roseOscuro text-[25px] md:text-5xl font-bold border-b-4 p-5 border-roseOscuro text">Doações transformam o mundo!</h2>
