...
export function Home() {
  ...
  useGSAP(() => {
    gsap.from('#main .text, #main p, #main strong', {
      scrollTrigger: {
        trigger: '.text',
        toggleActions: 'play'
      },
      y: 80, // Controla a posição do inicio da animação (Verticalmente)
      x: 0, // Controla a posição do inicio da animação (Horizontalmente)
      delay: -.1, // Atraso na animação como um todo
      duration: .5, // Velocidade da animação
      stagger: .3, // Atraso no inicio da animação de cada item
