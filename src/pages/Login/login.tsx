...
export function Login() {
  ...
  return (
    <div className="flex flex-col items-center w-[450px] bg-white py-6 my-[50px] mx-auto rounded-3xl shadow-custom">
      <h1 className="text-[25px] font-bold border-b-8 pb-1 border-b-[#F43F5E] rounded-lg">Faça seu login</h1>
      ...
      <form className="mt-[40px] space-y-6 flex flex-col items-center" onSubmit={login}>
        <div className="flex flex-col gap-1">
          ...
          <input className="bg-[#e5e5e5] w-[300px] h-10 text-[18px] px-2 rounded-2xl"
            type="email"
            id="usuario"
            name="usuario"
            placeholder="E-mail"
        ...
        <button className="w-[120px] h-10 bg-rose-500 text-[18px] font-bold rounded-3xl text-rose-50 hover:bg-red-700 hover:scale-110 transition-all" type="submit">
